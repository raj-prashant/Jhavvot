      ...
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-500 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-control">
            ...
            <span className="label-text text-purple-600">Male</span>
            <input type="checkbox" name="" className="checkbox border-purple-900"  checked={inputs.gender==="male"} onChange={()=>handleCheckboxChange("male")} /></label>
          </div>
          <div className="form-control">
            <label htmlFor="" className={`label gap-2 cursor-pointer ${inputs.gender==="female" ? "selected" : ""}`}>
            <span className="label-text text-purple-600">Female</span>
            <input type="checkbox" name="" className="checkbox border-purple-900"  checked={inputs.gender==="female"} onChange={()=>handleCheckboxChange("female")} /></label>
          </div>
          </div>
